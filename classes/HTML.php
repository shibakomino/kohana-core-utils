...
class HTML
{
    ...
    {
        return htmlspecialchars((string)$value, ENT_QUOTES, mb_internal_encoding(), $double_encode);
    }
    ...
    {
        return htmlentities((string)$value, ENT_QUOTES, mb_internal_encoding(), $double_encode);
    }
